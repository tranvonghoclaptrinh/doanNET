...
namespace QL_TrungTamNgoaiNgu.Models
{
    ...
    public sealed class DangKyHocVienRow
    {
    ...
    public sealed class HoaDonHocPhiViewRow
    {
        public int MaHoaDon { get; set; }
        public int MaDangKy { get; set; }
        public int MaHocVien { get; set; }
    ...
    public sealed class GiaoDichThanhToanViewRow
    {
    ...
    public sealed class DiemSoViewRow
    {
        public int MaDiem { get; set; }
        public int MaDangKy { get; set; }
        public int MaHocVien { get; set; }
